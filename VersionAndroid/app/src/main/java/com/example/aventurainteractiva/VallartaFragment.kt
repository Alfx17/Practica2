...
class VallartaFragment : Fragment() {
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_vallarta, container, false)
        ...
        val botonVallar = view.findViewById<Button>(R.id.buttonVall)
        botonVallar.setOnClickListener {
            activity?.finish()
        }
